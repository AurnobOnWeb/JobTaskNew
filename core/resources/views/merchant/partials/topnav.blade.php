                ...
                <button data-bs-toggle="dropdown" data-display="static" type="button" aria-haspopup="true"
                    ...
                    <span class="navbar-user">
                        {{-- <span class="navbar-user__thumb"><img
                                src="{{ getImage(getFilePath('adminProfile') . '/' . auth()->guard('merchant')->user()->name, getFileSize('adminProfile')) }}"
                                alt="image"></span> --}}
                        <span class="navbar-user__info">
                            <span class="navbar-user__name">{{ auth()->guard('merchant')->user()->name ??
                                'Merchant'}}</span>
                        </span>
                    </span>
                </button>
