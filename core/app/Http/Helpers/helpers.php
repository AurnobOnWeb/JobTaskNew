...
{
    $jsonUrl = resource_path('views/frontend/sections.json');
...
//     } else {
//         $elements = Frontend::when($limit != null, function ($q) use ($limit) {
//             return $q->limit($limit);
//         });
//         if ($orderById) {
//             $content = $elements->where('data_keys', $dataKeys)->orderBy('id')->get();
//         } else {
//             $content = $elements->where('data_keys', $dataKeys)->orderBy('id', 'desc')->get();
//         }
//     }
//     return $content;
// }
...
function frontendImage($sectionName, $image, $size = null)
{
